...
function Sidebar() {
  ...
  return (
    <div
      className={`fixed z-20 bg-[#212121] h-full border-r-[2px] border-rgba(255,255,255,0.05) ${
    ...
    >
      ...
      <nav className="h-full flex flex-col justify-between">
        ...
        {isSidebarOpen && (
          <footer className="mb-[5rem] p-4 border-t-[2px] border-rgba(255,255,255,0.05) text-gray-300">
